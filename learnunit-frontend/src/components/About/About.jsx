    ...
    <Stack direction={['column', 'row']} spacing={['4', '4']}>
      ...
      <VStack justifyContent={'center'} alignItems={['center', 'flex-start']}>
        <Text px={8}>
          ...
          At LearnUnit we provide quality content at affordable prices.
        </Text>
      </VStack>
    </Stack>
  );
...
const TandC = ({ termsAndCondition }) => (
  <Box mt={'12'}>
    ...
    <Heading my={'4'} size={'xs'}>
      Refund will be given if cancelled within 10 days of subscription
    </Heading>
  </Box>
);
      ...
      >
        ...
        >
          <Text
            ...
            textAlign={['center', 'left']}
          >
            LearnUnit is a video streaming platform with premium courses from
            top experts all over the world that are available for premium
            subscribers. We promise to deliver high Quality courses and teach
            you from beginners to advance levels of concepts.
          </Text>
          <Link to={'/subscribe'} className="shady">
            <Button colorScheme="messenger">Checkout Our Plan</Button>
          </Link>
        </Stack>
        <Flex
          width={'100%'}
